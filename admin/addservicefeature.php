        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add Service Feature</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
...
<?php
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
        ...
        $query = "INSERT INTO tbl_service_feature(title, s_id) VALUES('$title', '$s_id')";
...
<?php } } ?>
						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            placeholder="Enter Service Feature Details"
                            ></textarea>
                          </div>
                        </div>
